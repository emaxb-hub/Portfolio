...
test("uses the Cyber Lime portfolio implementation", async () => {
  ...
  assert.match(portfolio, /start:\s*"top 82%"/);
  assert.match(portfolio, /end:\s*"\+=1100"/);
  assert.match(portfolio, /scrub:\s*1\.1/);
  assert.match(portfolio, /RollingWheel/);
  assert.match(portfolio, /AmbientBackdrop/);
  assert.match(portfolio, /className="ambient-backdrop"/);
  assert.match(portfolio, /className="ambient-ribbons"/);
  assert.match(portfolio, /ribbon-path ribbon-lime/);
  assert.match(portfolio, /ribbon-path ribbon-pink/);
  assert.match(portfolio, /className=\{classes\}/);
  assert.match(portfolio, /className="quote-stage"/);
  assert.match(portfolio, /className="quote-wheel"/);
  assert.match(portfolio, /className="about-wheel"/);
  assert.match(portfolio, /\.rolling-wheel/);
  assert.match(portfolio, /scrub:\s*1\.4/);
  ...
  assert.match(css, /\.ambient-backdrop/);
  assert.match(css, /\.ambient-smoke/);
  assert.match(css, /\.ambient-ribbons/);
  assert.match(css, /\.ribbon-path/);
  assert.match(css, /@keyframes smokeDrift/);
  assert.match(css, /@keyframes ribbonDrift/);
  assert.match(css, /\.rolling-wheel/);
  assert.match(css, /\.quote-stage/);
  assert.match(css, /\.about-wheel/);
